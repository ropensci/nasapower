...
#'   of \CRANpkg{nasapower}.  Please use the \CRANpkg{DSSAT} package with data
#'   retrieved using \code{\link{get_power}} if you require this functionality.
#'
#' @description Get \acronym{POWER} values for a single point or region and
#'   create an \acronym{ICASA} format text file suitable for use in
#'   \acronym{DSSAT} for crop modelling; saving it to local disk.
#'
...
create_icasa <- function(lonlat,
  ...
  .Deprecated(
    ...
    The NASA POWER web API offers functionality to download ICASA format files
    directly in your browser for the 'AG' community. To download ICASA format
    files for use with DSSAT please visit:
