...
acknowledgement be included: "These data were obtained from the NASA Langley
...
[Contributor Code of Conduct](https://github.com/ropensci/nasapower/blob/master/CONDUCT.md).
