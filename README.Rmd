---
title: "_nasapower_: NASA POWER API Client <img align='right' src='man/figures/logo.png'>"
...
POWER (Prediction Of Worldwide Energy Resource) data are freely available for download with a spatial resolution of 0.5 x 0.625 degree latitude and longitude for meteorology and  1 x 1 degree latitude and longitude for solar parameters with various temporal resolutions depending on the POWER parameter and community.

**Note that the data are not static and may be replaced with improved data.** Please see [https://power.larc.nasa.gov/docs/services/](https://power.larc.nasa.gov/docs/services/) for detailed information in this regard.
...
**The current version on CRAN is out of date with the new POWER API V2.**
...
A development version that is in beta testing currently has functionality to work with the POWER API V2 is available through GitHub.
