...
POWER (Prediction Of Worldwide Energy Resource) data are freely available for download with varying spatial resolutions dependent on the original dat and with several temporal resolutions depending on the POWER parameter and community.
