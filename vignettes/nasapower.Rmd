...
# create dataframes for the individual parameters and drop the parameter field.
RH2M <- rasterFromXYZ(subset(power, PARAMETER == "RH2M")[, -c(3:8)])

T2M <- rasterFromXYZ(subset(power, PARAMETER == "T2M")[, -c(3:8)])
```
