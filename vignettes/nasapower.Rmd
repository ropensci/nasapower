...
#>  1  152. -27.5  1985     1     1     1 1985-01-01  54.7
#>  2  152. -27.5  1985     1     2     2 1985-01-02  42.1
#>  3  152. -27.5  1985     1     3     3 1985-01-03  43.4
#>  4  152. -27.5  1985     1     4     4 1985-01-04  48.9
#>  5  152. -27.5  1985     1     5     5 1985-01-05  55.3
#>  6  152. -27.5  1985     1     6     6 1985-01-06  60.2
#>  7  152. -27.5  1985     1     7     7 1985-01-07  63.1
#>  8  152. -27.5  1985     1     8     8 1985-01-08  70.6
#>  9  152. -27.5  1985     1     9     9 1985-01-09  60  
#> 10  152. -27.5  1985     1    10    10 1985-01-10  45.2
#> # … with 21 more rows, and 2 more variables: T2M <dbl>,
#> #   PRECTOTCORR <dbl>
```
...
#>    <dbl> <dbl> <dbl> <int> <int> <int> <date>     <dbl>
#>  1 -28.2  151.  1985     1     1     1 1985-01-01  43.6
#>  2 -28.2  151.  1985     1     1     1 1985-01-01  44.4
#>  3 -28.2  152.  1985     1     1     1 1985-01-01  52.6
#>  4 -28.2  152.  1985     1     1     1 1985-01-01  57.7
#>  5 -28.2  153.  1985     1     1     1 1985-01-01  61.4
#>  6 -28.2  153.  1985     1     1     1 1985-01-01  66.1
#>  7 -27.8  151.  1985     1     1     1 1985-01-01  45.8
#>  8 -27.8  151.  1985     1     1     1 1985-01-01  47.9
#>  9 -27.8  152.  1985     1     1     1 1985-01-01  53.4
#> 10 -27.8  152.  1985     1     1     1 1985-01-01  56.7
#> # … with 62 more rows, and 1 more variable: T2M <dbl>
```
...
#>  
#> # A tibble: 144 × 17
#>    PARAMETER       YEAR   LAT   LON   JAN   FEB   MAR   APR
#>    <chr>          <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>
#>  1 ALLSKY_SFC_SW…  1984 -25.8  151.  6.01  6.49  5.79  4.67
#>  2 ALLSKY_SFC_SW…  1984 -25.8  151.  5.92  5.97  5.64  4.37
#>  3 ALLSKY_SFC_SW…  1984 -25.8  152.  5.92  5.97  5.64  4.37
#>  4 ALLSKY_SFC_SW…  1984 -25.8  152.  5.96  5.85  5.56  4.26
#>  5 ALLSKY_SFC_SW…  1984 -25.8  153.  5.96  5.85  5.56  4.26
#>  6 ALLSKY_SFC_SW…  1984 -25.8  153.  6.23  6.05  5.88  4.26
#>  7 ALLSKY_SFC_SW…  1984 -26.2  151.  5.97  6.65  6     4.66
#>  8 ALLSKY_SFC_SW…  1984 -26.2  151.  6     6.38  5.71  4.38
#>  9 ALLSKY_SFC_SW…  1984 -26.2  152.  6     6.38  5.71  4.38
#> 10 ALLSKY_SFC_SW…  1984 -26.2  152.  5.75  5.96  5.37  4.13
#> # … with 134 more rows, and 9 more variables: MAY <dbl>,
#> #   JUN <dbl>, JUL <dbl>, AUG <dbl>, SEP <dbl>, OCT <dbl>,
...
#> 1  152. -27.5 T2M        24.7  23.7  22.0  19.0  15.1  12.6
#> 2  152. -27.5 RH2M       64.7  69.6  71.1  70.5  69.1  75.1
#> # … with 7 more variables: JUL <dbl>, AUG <dbl>,
