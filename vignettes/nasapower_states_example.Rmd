...
```{r query_power, eval=TRUE, include=TRUE}

power <- vector(mode = "list", 2) # hold two growing seasons
precip <- vector(mode = "list", nrow(coords)) # hold the cells

# the seasons aren't just two days, but to shorten run time for this example,
# we'll use two days only
seasons <- list(
  c("2014-11-01", "2014-11-02"),
  c("2015-11-01", "2015-11-02")
)
