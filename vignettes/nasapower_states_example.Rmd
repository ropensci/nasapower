...
#> Error in (function (classes, fdef, mtable) : unable to find an inherited method for function 'mask' for signature '"SpatRaster", "sf"'
...
#> Error in (function (cond) : error in evaluating the argument 'x' in selecting a method for function 'as.data.frame': Expecting a single value: [extent=104].
RS_coords <- as.data.frame(xyFromCell(RS_coords, 1:ncell(RS_coords)), type = "xyz")
names(PR_coords) <- names(RS_coords) <- c("LON", "LAT")
#> Error in `names<-`(`*tmp*`, value = c("LON", "LAT")): incorrect number of names
...
#>    colorspace           1.4-2      2020-05-04 [1]
#>    crayon               1.3.4      2017-09-16 [1]
#>    crul                 0.9.0      2019-11-06 [1]
#>    curl                 4.3        2019-12-02 [1]
#>    data.table         * 1.12.9     2020-07-19 [1]
#>    DBI                  1.1.0      2019-12-15 [1]
#>    desc                 1.2.0      2018-05-01 [1]
#>    devtools           * 2.3.0      2020-04-10 [1]
#>    digest               0.6.25     2020-02-23 [1]
#>    dplyr              * 1.0.0      2020-05-29 [1]
#>    DSSAT              * 0.0.2      2020-05-18 [1]
#>    dtraster           * 0.1        2020-07-19 [1]
...
#>  P nasapower          * 1.1.3.9000 2020-07-19 [?]
...
#>    Rcpp                 1.0.5.1    2020-07-14 [1]
#>    rcropmod           * 0.2.2      2020-07-19 [1]
#>    readr                1.3.1      2018-12-21 [1]
#>    remotes              2.1.1      2020-02-15 [1]
#>    rgdal              * 1.5-12     2020-06-26 [1]
#>    rgeos                0.5-3      2020-05-08 [1]
#>    rlang                0.4.7      2020-07-09 [1]
#>    rmarkdown            2.3        2020-06-18 [1]
#>    rnaturalearth      * 0.1.0      2017-03-21 [1]
#>    rnaturalearthhires   0.2.0      2020-07-15 [1]
...
#>  CRAN (R 4.0.1)                                  
#>  CRAN (R 4.0.2)                                  
#>  Github (ldemaz/dtraster@a5635a5)                
#>  CRAN (R 4.0.1)                                  
#>  CRAN (R 4.0.1)                                  
#>  CRAN (R 4.0.1)                                  
#>  CRAN (R 4.0.1)                                  
...
#>  CRAN (R 4.0.2)                                  
#>  local                                           
#>  Github (ldemaz/rcropmod@94eaf9f)                
#>  CRAN (R 4.0.0)                                  
#>  CRAN (R 4.0.0)                                  
#>  CRAN (R 4.0.2)                                  
#>  CRAN (R 4.0.1)                                  
...
#>  CRAN (R 4.0.0)                                  
#>  CRAN (R 4.0.1)                                  
#>  Github (ropenscilabs/rnaturalearthhires@2ed7a93)
#>  CRAN (R 4.0.0)                                  
#>  CRAN (R 4.0.0)                                  
#>  CRAN (R 4.0.0)                                  
#>  CRAN (R 4.0.0)                                  
