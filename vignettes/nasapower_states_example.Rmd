...
PR_coords <-
  as.data.frame(xyFromCell(PR_coords, 1:ncell(PR_coords)), type = "xyz")
RS_coords <-
  as.data.frame(xyFromCell(RS_coords, 1:ncell(RS_coords)), type = "xyz")
...
#>  nasapower          * 1.1.3.9000 2020-08-24 [1] CRAN (R 4.0.2)
...
#>  rnaturalearthhires   0.2.0      2020-08-25 [1] local         
...
#>  terra              * 0.8-6      2020-08-01 [1] CRAN (R 4.0.2)
