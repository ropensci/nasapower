...
is provided by the package, we can compare it with NASA-POWER radiation for
Kingsthorpe, Queensland for 2010.

To do that first we need to use `get_cell()` to fetch the data necessary to
calculate SRAD for 2010.
